...
type journal struct {
	...
	dirties      map[ogTypes.Address]int // Dirty accounts and the number of changes
...
func newJournal() *journal {
	return &journal{
		dirties:      make(map[ogTypes.Address]int),
...
func (ch createObjectChange) Dirtied() ogTypes.Address {
	return ch.account
}
...
func (ch resetObjectChange) Dirtied() ogTypes.Address {
...
func (ch suicideChange) Dirtied() ogTypes.Address {
	return ch.account
}
...
func (ch touchChange) Dirtied() ogTypes.Address {
	return ch.account
}
...
func (ch balanceChange) Dirtied() ogTypes.Address {
	return ch.account
}
...
func (ch nonceChange) Dirtied() ogTypes.Address {
	return ch.account
}
...
func (ch codeChange) Revert(s *StateDB) {
	stobj := s.getStateObject(ch.account)
	if stobj != nil {
		stobj.setCode(ogTypes.BytesToHash32(ch.prevhash), ch.prevcode)
	}
}

func (ch codeChange) Dirtied() ogTypes.Address {
	return ch.account
}
...
func (ch storageChange) Dirtied() ogTypes.Address {
	return ch.account
}
...
func (ch refundChange) Dirtied() ogTypes.Address {
	return nil
}
...
func (ch addLogChange) Dirtied() ogTypes.Address {
	return nil
}
...
func (ch addPreimageChange) Dirtied() ogTypes.Address {
	return nil
}
...
func (ch createTokenChange) Dirtied() ogTypes.Address {
	return nil
}
...
func (ch resetTokenChange) Dirtied() ogTypes.Address {
	return nil
}
...
func (ch reIssueChange) Dirtied() ogTypes.Address {
	return nil
}
...
func (ch destroyChange) Dirtied() ogTypes.Address {
	return nil
}
