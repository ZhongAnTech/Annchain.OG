...
type OgEngine struct {
	...
	quit                          chan bool
	myNewIncomingMessageEventChan chan *transport_event.WireMessage                   // subscribe to NewIncomingMessageEvent
...
func (o *OgEngine) InitDefault() {
	o.myNewIncomingMessageEventChan = make(chan *transport_event.WireMessage)
...
func (o *OgEngine) RegisterSubscriberNewOutgoingMessageEvent(sub transport_event.NewOutgoingMessageEventSubscriber) {
	o.newOutgoingMessageSubscribers = append(o.newOutgoingMessageSubscribers, sub)
}

func (o *OgEngine) GetNewIncomingMessageEventChannel() chan *transport_event.WireMessage {
