...
func newTestDag(t *testing.T, dbDirPrefix string) (*core.Dag, *protocol_message.Sequencer, func()) {
	conf := core.DagConfig{}
...
func newTestDagTx(nonce uint64) *protocol_message.Tx {
