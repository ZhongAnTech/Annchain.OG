...
func (a *Archive) GetBase() *protocol_message.TxBase {
	return &a.TxBase
}
...
func (c *Archive) RawTxi() protocol_message.RawTxi {
	return c.RawArchive()
}

func RandomArchive() *Archive {
	return &Archive{TxBase: protocol_message.TxBase{
