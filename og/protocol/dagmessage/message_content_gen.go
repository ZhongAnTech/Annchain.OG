...
func (z *MessageContentTx) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if cap(z.ParentsHash) >= int(zb0002) {
		...
		z.ParentsHash = make([]types.Hash, zb0002)
	}
...
func (z *MessageContextSequencer) Msgsize() (s int) {
	...
	s += msgp.Uint64Size + msgp.Uint64Size + z.Issuer.Msgsize() + msgp.BytesPrefixSize + len(z.PublicKey) + msgp.BytesPrefixSize + len(z.Signature) + z.StateRoot.Msgsize()
	return
}
