...
func (z *TokenInfo) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	err = PublicOffering.DecodeMsg(dc)
	if err != nil {
...
func (z *TokenInfo) EncodeMsg(en *msgp.Writer) (err error) {
	...
	err = PublicOffering.EncodeMsg(en)
	if err != nil {
		err = msgp.WrapError(err, "PublicOffering")
		return
	}
...
func (z *TokenInfo) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// array header, size 4
	o = append(o, 0x94)
	o, err = PublicOffering.MarshalMsg(o)
	if err != nil {
		err = msgp.WrapError(err, "PublicOffering")
		return
	}
...
func (z *TokenInfo) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	bts, err = PublicOffering.UnmarshalMsg(bts)
	if err != nil {
		err = msgp.WrapError(err, "PublicOffering")
		return
	}
...
func (z *TokenInfo) Msgsize() (s int) {
	s = 1 + PublicOffering.Msgsize() + z.Sender.Msgsize()
	if z.CurrentValue == nil {
		s += msgp.NilSize
	} else {
