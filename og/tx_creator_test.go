...
func TestBuildDag(t *testing.T) {
	...
	txs := []types.Txi{
		...
		txc.NewSignedTx(common.HexToAddress("0x01"), common.HexToAddress("0x02"), math.NewBigInt(10), 0, privateKey,0),
		txc.NewSignedSequencer(common.Address{}, 1, 1, privateKey),
		txc.NewSignedTx(common.HexToAddress("0x02"), common.HexToAddress("0x03"), math.NewBigInt(9), 0, privateKey,0),
		txc.NewSignedTx(common.HexToAddress("0x03"), common.HexToAddress("0x04"), math.NewBigInt(8), 0, privateKey,0),
