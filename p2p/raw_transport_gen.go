...
func (z *RawHandshakeResponseMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 3
	// write "RemotePubkey"
	err = en.Append(0x83, 0xac, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x50, 0x75, 0x62, 0x6b, 0x65, 0x79)
	if err != nil {
		return
	}
...
func (z *RawHandshakeResponseMsg) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 3
	// string "RemotePubkey"
	o = append(o, 0x83, 0xac, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x50, 0x75, 0x62, 0x6b, 0x65, 0x79)
...
// DecodeMsg implements msgp.Decodable
func (z *RawTransport) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
	...
	for zb0001 > 0 {
		...
		switch msgp.UnsafeString(field) {
		case "MsgReadWriter":
			err = z.MsgReadWriter.DecodeMsg(dc)
			if err != nil {
				return
			}
		default:
...
// EncodeMsg implements msgp.Encodable
func (z *RawTransport) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "MsgReadWriter"
	err = en.Append(0x81, 0xad, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x61, 0x64, 0x57, 0x72, 0x69, 0x74, 0x65, 0x72)
	if err != nil {
		return
	}
	err = z.MsgReadWriter.EncodeMsg(en)
	if err != nil {
		return
	}
	return
...
// MarshalMsg implements msgp.Marshaler
func (z *RawTransport) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "MsgReadWriter"
	o = append(o, 0x81, 0xad, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x61, 0x64, 0x57, 0x72, 0x69, 0x74, 0x65, 0x72)
	o, err = z.MsgReadWriter.MarshalMsg(o)
	if err != nil {
		return
	}
	return
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *RawTransport) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
	...
	for zb0001 > 0 {
		...
		switch msgp.UnsafeString(field) {
		case "MsgReadWriter":
			bts, err = z.MsgReadWriter.UnmarshalMsg(bts)
			if err != nil {
				return
			}
		default:
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *RawTransport) Msgsize() (s int) {
	s = 1 + 14 + z.MsgReadWriter.Msgsize()
	return
}
