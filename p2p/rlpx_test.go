...
func TestSharedSecret(t *testing.T) {
	prv0, _ := ogcrypto2.GenerateKey() // = ecdsa.GenerateKey(ogcrypto.S256(), rand.Reader)
	pub0 := &prv0.PublicKey
	prv1, _ := ogcrypto2.GenerateKey()
	pub1 := &prv1.PublicKey
...
func TestRlpxFrameRW_ReadMsg(t *testing.T) {
	...
	rw := newRLPXFrameRW(buf, secrets{
		AES:        ogcrypto2.Keccak256(),
		MAC:        ogcrypto2.Keccak256(),
		IngressMAC: hash,
		EgressMAC:  hash,
	})
...
func TestHandshakeForwardCompatibility(t *testing.T) {
	var (
		keyA, _       = ogcrypto2.HexToECDSA("49a7b37aa6f6645917e7b807e9d1c00d4fa71f18343b0d4122a4d2df64dd6fee")
		keyB, _       = ogcrypto2.HexToECDSA("b71c71a67e1177ad4e901695e1b4b9ee17ae16c6668d313eac2f96dbcda3f291")
		pubA          = ogcrypto2.FromECDSAPub(&keyA.PublicKey)[1:]
		pubB          = ogcrypto2.FromECDSAPub(&keyB.PublicKey)[1:]
		ephA, _       = ogcrypto2.HexToECDSA("869d6ecf5211f1cc60418a13b9d870b22959d0c16f02bec714c960dd2298a32d")
		ephB, _       = ogcrypto2.HexToECDSA("e238eb8e04fee6511ab04c6dd3c89ce097b11f25d584863ac2b6d5b35b1847e4")
		ephPubA       = ogcrypto2.FromECDSAPub(&ephA.PublicKey)[1:]
		ephPubB       = ogcrypto2.FromECDSAPub(&ephB.PublicKey)[1:]
