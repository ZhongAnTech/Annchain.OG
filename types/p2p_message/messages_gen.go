...
func (z *MessageBodyData) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		if z.RawSequencer == nil {
			z.RawSequencer = new(tx_types.RawSequencer)
		}
	...
	if dc.IsNil() {
		...
		if z.RawTxs == nil {
			z.RawTxs = new(tx_types.TxisMarshaler)
		}
...
func (z *MessageCampaign) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		if z.RawCampaign == nil {
			z.RawCampaign = new(tx_types.RawCampaign)
		}
...
func (z *MessageConsensusDkgDeal) Msgsize() (s int) {
	s = 1 + msgp.Uint32Size + msgp.BytesPrefixSize + len(z.Data) + msgp.BytesPrefixSize + len(z.PublicKey) + msgp.BytesPrefixSize + len(z.Signature) + msgp.Uint64Size
	return
}
...
func (z *MessageConsensusDkgSigSets) Msgsize() (s int) {
	s = 1 + msgp.BytesPrefixSize + len(z.PkBls) + msgp.BytesPrefixSize + len(z.PublicKey) + msgp.BytesPrefixSize + len(z.Signature) + msgp.Uint64Size
	return
}
...
func (z *MessageSyncRequest) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		if cap(*z.HashTerminats) >= int(zb0002) {
			*z.HashTerminats = (*z.HashTerminats)[:zb0002]
		} else {
			*z.HashTerminats = make(HashTerminats, zb0002)
		}
		for za0001 := range *z.HashTerminats {
			err = dc.ReadExactBytes(((*z.HashTerminats)[za0001])[:])
			if err != nil {
				return
			}
		}
	...
	if dc.IsNil() {
		...
		z.Filter.Capacity, err = dc.ReadUint32()
		if err != nil {
			return
		}
	}
...
func (z *MessageSyncRequest) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if z.HashTerminats == nil {
		...
		err = en.WriteArrayHeader(uint32(len(*z.HashTerminats)))
		if err != nil {
			return
		}
		for za0001 := range *z.HashTerminats {
			err = en.WriteBytes(((*z.HashTerminats)[za0001])[:])
			if err != nil {
				return
			}
		}
	...
	if z.Filter == nil {
		...
		err = en.WriteUint32(z.Filter.Capacity)
		if err != nil {
			return
		}
	}
...
func (z *MessageSyncRequest) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if z.HashTerminats == nil {
		...
		o = msgp.AppendArrayHeader(o, uint32(len(*z.HashTerminats)))
		for za0001 := range *z.HashTerminats {
			o = msgp.AppendBytes(o, ((*z.HashTerminats)[za0001])[:])
		}
	}
	if z.Filter == nil {
		o = msgp.AppendNil(o)
		...
		o = msgp.AppendUint32(o, z.Filter.Capacity)
	}
	if z.Height == nil {
		o = msgp.AppendNil(o)
	} else {
...
func (z *MessageSyncRequest) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if msgp.IsNil(bts) {
		...
		for za0001 := range *z.HashTerminats {
			bts, err = msgp.ReadExactBytes(bts, ((*z.HashTerminats)[za0001])[:])
			if err != nil {
				return
			}
		}
	...
	if msgp.IsNil(bts) {
		...
		z.Filter.Capacity, bts, err = msgp.ReadUint32Bytes(bts)
		if err != nil {
			return
		}
	}
...
func (z *MessageSyncRequest) Msgsize() (s int) {
	...
	if z.HashTerminats == nil {
		...
		s += msgp.ArrayHeaderSize + (len(*z.HashTerminats) * (4 * (msgp.ByteSize)))
	}
	if z.Filter == nil {
		s += msgp.NilSize
	} else {
		s += 1 + msgp.BytesPrefixSize + len(z.Filter.Data) + msgp.Uint32Size + msgp.Uint32Size
	}
	if z.Height == nil {
		s += msgp.NilSize
	} else {
...
func (z *MessageTermChange) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		if z.RawTermChange == nil {
			z.RawTermChange = new(tx_types.RawTermChange)
		}
