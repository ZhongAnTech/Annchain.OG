...
func TestSequencer(t *testing.T) {
	...
	seq1 := Sequencer{TxBase: types.TxBase{ParentsHash: common.Hashes{common.HexToHash("0x0")}}, Issuer: &addr}
	seq2 := Tx{TxBase: types.TxBase{ParentsHash: common.Hashes{common.HexToHash("0x0")}},
		To:    common.HexToAddress("0x1"),
		From:  &from,
		Value: math.NewBigInt(0),
	}

	seq3 := Sequencer{TxBase: types.TxBase{ParentsHash: common.Hashes{seq1.CalcMinedHash(), seq2.CalcMinedHash()}}}
...
func TestSequencerRawSize(t *testing.T) {
	...
	// make 1000 hashes
	for i := 0; i < n; i++ {
		//seq.Hashes = append(seq.Hashes, common.HexToHash("0xAABB000000000000000000000000CCDDCCDD000000000000000000000000EEFF").Bytes)
	}
