...
func (ovm *OVM) create(caller vmtypes.ContractRef, codeAndHash *vmtypes.CodeAndHash, gas uint64, value *big.Int, address common.Address, txCall bool) ([]byte, common.Address, uint64, error) {
	ctx := ovm.VMContext
