...
type Caller interface {
	...
	Call(me ContractRef, addr types.Address, data []byte, gas uint64, value *big.Int) (resp []byte, leftOverGas uint64, err error)
	...
	Create(me ContractRef, data []byte, gas uint64, value *big.Int) (resp []byte, contractAddr types.Address, leftOverGas uint64, err error)
